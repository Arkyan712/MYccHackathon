...
.welcome-bg {
  position: fixed;
  inset: 0;
  background-image: url('/assets/welcom1.jpg');
...
.bg-overlay {
  ...
  inset: 0;
  background: 
    radial-gradient(ellipse 80% 50% at 20% 30%, rgba(99, 102, 241, 0.2) 0%, transparent 50%),
    radial-gradient(ellipse 60% 40% at 80% 70%, rgba(168, 85, 247, 0.18) 0%, transparent 50%),
    linear-gradient(135deg, rgba(30, 58, 95, 0.55) 0%, rgba(45, 74, 111, 0.45) 50%, rgba(30, 58, 95, 0.55) 100%);
}
...
.feature-icon-wrap {
  width: 64px;
  height: 64px;
  background: rgba(143, 188, 212, 0.2);
  border-radius: 16px;
  display: flex;
  align-items: center;
  justify-content: center;
