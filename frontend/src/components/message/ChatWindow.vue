...
.chat-body { flex: 1; overflow-y: auto; padding: 20px; background: var(--bg); }
...
.chat-input-bar { padding: 12px 16px; border-top: 1px solid var(--card-border); background: #fff; flex-shrink: 0; }
.chat-input-row { display: flex; align-items: center; }
.chat-input { flex: 1; }
.chat-input :deep(.el-input-group__append) {
  background: var(--primary-gradient); border: none; padding: 0;
}
